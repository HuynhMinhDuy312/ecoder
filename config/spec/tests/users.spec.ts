...
// import { pErr } from 'views/shared/functions';
// import { p as userPaths } from '@routes/user-router';
// import {
//     ParamMissingError,
//     UserNotFoundError,
// } from 'views/shared/errors';
...
//                 ),
//             ];
//             spyOn(userRepo, 'getAll').and.returnValue(
...
//                     const retUsers: IUser[] = respUsers.map(
//                         (user: IUser) => {
...
//             // Setup spy
//             spyOn(userRepo, 'persists').and.returnValue(
//                 Promise.resolve(true)
//             );
//             spyOn(userRepo, 'update').and.returnValue(
//                 Promise.resolve()
//             );
//             // Call Api
//             callApi(userData).end((err: Error, res: Response) => {
...
//             return agent.delete(
//                 deleteUserPath.replace(':id', id.toString())
//             );
//         };
...
//                 Promise.resolve(true)
//             );
//             spyOn(userRepo, 'delete').and.returnValue(
//                 Promise.resolve()
//             );
//             // Call api
